  ...
  private showOdds(): void {
    ...
    const rows = registry
      ...
      .map((g) => {
        ...
        return `<div style="display:flex;align-items:center;justify-content:space-between;padding:8px 0;border-bottom:1px solid #2A3340;">
    ...
    this.oddsOverlay = createOverlay((root) => {
      ...
      card.innerHTML =
        `<h2 style="margin:0 0 4px;color:#fff;font-size:20px;text-align:center;">소환 확률 공개</h2>` +
